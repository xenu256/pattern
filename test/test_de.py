...
class TestInflection(unittest.TestCase):
    ...
    def test_predicative(self):
        # Assert the accuracy of the predicative algorithm ("großer" =>
        # "groß").
        from pattern.db import Datasheet
        i, n = 0, 0
    ...
    def test_conjugate(self):
        ...
        for (v1, v2, tense) in (
                ...
                ("sein",  "sei",
                 (de.PRESENT, 2, de.SINGULAR, de.IMPERATIVE)),
                ("sein",  "seien",
                 (de.PRESENT, 1, de.PLURAL, de.IMPERATIVE)),
                ("sein",  "seid",
                 (de.PRESENT, 2, de.PLURAL, de.IMPERATIVE)),
                ("sein", "sei",
                 (de.PRESENT, 1, de.SINGULAR, de.SUBJUNCTIVE)),
                ("sein", "seiest",
                 (de.PRESENT, 2, de.SINGULAR, de.SUBJUNCTIVE)),
                ("sein", "sei",
                 (de.PRESENT, 3, de.SINGULAR, de.SUBJUNCTIVE)),
                ("sein", "seien",
                 (de.PRESENT, 1, de.PLURAL, de.SUBJUNCTIVE)),
                ("sein", "seiet",
                 (de.PRESENT, 2, de.PLURAL, de.SUBJUNCTIVE)),
                ("sein", "seien",
                 (de.PRESENT, 3, de.PLURAL, de.SUBJUNCTIVE)),
                ("sein", "wäre",
                 (de.PAST, 1, de.SINGULAR, de.SUBJUNCTIVE)),
                ("sein", "wärest",
                 (de.PAST, 2, de.SINGULAR, de.SUBJUNCTIVE)),
                ("sein", "wäre",
                 (de.PAST, 3, de.SINGULAR, de.SUBJUNCTIVE)),
...
class TestParser(unittest.TestCase):
    ...
    def test_find_lemmata(self):
        ...
        v = de.parser.find_lemmata(
            [["Ich", "PRP"], ["sage", "VB"], ["schöne", "JJ"], ["Dinge", "NNS"]])
        self.assertEqual(v, [
            ["Ich", "PRP", "ich"],
            ["sage", "VB", "sagen"],
            ["schöne", "JJ", "schön"],
    ...
    def test_parse(self):
        ...
        # 1) "der große Hund" is a noun phrase, "auf der Matte" is a
        ...
        # Note how articles are problematic ("der" can be male subject but also
        # plural possessive).
        v = de.parser.parse(
            "Der große Hund sitzt auf der Matte.", lemmata=True)
        self.assertEqual(v,
