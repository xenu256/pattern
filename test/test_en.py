...
class TestParser(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertTrue(
            isinstance(en.parse("ø ü", tokenize=True,  tags=False, chunks=False), str))
        self.assertTrue(
            isinstance(en.parse("ø ü", tokenize=False, tags=False, chunks=False), str))
        self.assertTrue(isinstance(en.parse("o u", encoding="ascii"), str))
        # 6) Assert optional parameters (i.e., setting all to False).
        self.assertEqual(
            en.parse("ø ü.", tokenize=True,  tags=False, chunks=False), "ø ü .")
        self.assertEqual(
            en.parse("ø ü.", tokenize=False, tags=False, chunks=False), "ø ü.")
...
class TestParseTree(unittest.TestCase):
    ...
    def test_sentence(self):
        ...
        self.assertEqual(isinstance(v.string, str), True)
